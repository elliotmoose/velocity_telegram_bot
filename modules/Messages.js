...
module.exports = {
    ...
    getWelcomeMessage: (name) => {
        ...
        "1) First off, I'll be sending you the daily verses that we're reading together as a ministry. Let's grow together in the word of God!\n" +
        "2) To get the latest passage(s) for the day, use the '/latest' command.\n" + 
        "3) You can submit a testimony to shout the name of Jesus by using the '/shouthisname' command!\n" + 
        "4) Want to hop on to our Sunday online service livestreams? Use '/livestream' to get the link!\n" +
        "5) We'd love to hear from you! You can send me feedback with the '/feedback' command.\n" + 
        "6) Lastly, if you don't want to receive the daily passages, use the '/unsubscribe' command. If you change your mind after, you can always '/subscribe' again!\n\n" + 
